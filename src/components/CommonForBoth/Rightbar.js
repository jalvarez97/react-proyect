          ...
          <SimpleBar style={{ height: "900px" }}>
            <div data-simplebar className="h-100">
              ...
              <div className="p-4">
                ...
                <div className="mb-2">
                  <Link to="//www.youtube.com/channel/UC-YCjN5maEHWO4S5JUMdttw/videos?view_as=subscriber" target="_blank">
                    <img
                      src={layout1}
                ...
                <div className="mb-2">
                  <Link
                    to="//www.youtube.com/channel/UC-YCjN5maEHWO4S5JUMdttw/videos?view_as=subscriber"
                    target="_blank"
                  >
                    <img
                      src={layout2}
